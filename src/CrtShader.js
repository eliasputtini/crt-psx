...
vec2 resolution = vec2(2000, 2000);
uniform sampler2D inputBuffer;  // Declare inputBuffer as a uniform
...
// 0.0 = none
// 1.0/8.0 = extreme
vec2 warp=vec2(1.0/16.0,1.0/24.0); 
...
return Test(ToLinear(texture(inputBuffer,pos.xy,-16.0).rgb));}
...
void main(){
  ...
  vec2 pos=Warp(fragCoord.xy/resolution.xy);
